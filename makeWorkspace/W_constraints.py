...
def cmodel(cid,nam,_f,_fOut, out_ws, diag, year):
  ...
  # Trigger single muon
  add_variation(WScales, fztoz_trig, "trig_sys_down"+tag, "wmn_weights_%s_mettrig_%s_Down"%(cid,cid), _fOut)
  add_variation(WScales, fztoz_trig, "trig_sys_up"+tag, "wmn_weights_%s_mettrig_%s_Up"%(cid,cid), _fOut)
  CRs[0].add_nuisance_shape("mettrig_%s"%cid,_fOut)

  # Trigger single electron
  add_variation(WScales_e, fztoz_trig, "trig_sys_down"+tag, "wen_weights_%s_mettrig_%s_Down"%(cid,cid), _fOut)
  add_variation(WScales_e, fztoz_trig, "trig_sys_up"+tag, "wen_weights_%s_mettrig_%s_Up"%(cid,cid), _fOut)
  ...
  ## Wmuon CR first
  add_variation(WScales, fwtowveto, "eleveto"+tag, "wmn_weights_%s_eveto_%s_Up"%(cid,cid), _fOut)
  add_variation(WScales, fwtowveto, "eleveto_Down"+tag, "wmn_weights_%s_eveto_%s_Down"%(cid,cid), _fOut)
  CRs[0].add_nuisance_shape("eveto_%s"%cid,_fOut)

  add_variation(WScales, fwtowveto, "muveto"+tag, "wmn_weights_%s_muveto_%s_Up"%(cid,cid), _fOut)
  add_variation(WScales, fwtowveto, "muveto_Down"+tag, "wmn_weights_%s_muveto_%s_Down"%(cid,cid), _fOut)
  CRs[0].add_nuisance_shape("muveto_%s"%cid,_fOut)

  add_variation(WScales, fwtowveto, "tauveto"+tag, "wmn_weights_%s_tauveto_%s_Up"%(cid,cid), _fOut)
  add_variation(WScales, fwtowveto, "tauveto_Down"+tag, "wmn_weights_%s_tauveto_%s_Down"%(cid,cid), _fOut)
  CRs[0].add_nuisance_shape("tauveto_%s"%cid,_fOut)

  ## W electron CR first
  add_variation(WScales_e, fwtowveto, "eleveto"+tag, "wen_weights_%s_eveto_%s_Up"%(cid,cid), _fOut)
  add_variation(WScales_e, fwtowveto, "eleveto_Down"+tag, "wen_weights_%s_eveto_%s_Down"%(cid,cid), _fOut)
  CRs[1].add_nuisance_shape("eveto_%s"%cid,_fOut)

  add_variation(WScales_e, fwtowveto, "muveto"+tag, "wen_weights_%s_muveto_%s_Up"%(cid,cid), _fOut)
  add_variation(WScales_e, fwtowveto, "muveto_Down"+tag, "wen_weights_%s_muveto_%s_Down"%(cid,cid), _fOut)
  CRs[1].add_nuisance_shape("muveto_%s"%cid,_fOut)

  add_variation(WScales_e, fwtowveto, "tauveto"+tag, "wen_weights_%s_tauveto_%s_Up"%(cid,cid), _fOut)
  add_variation(WScales_e, fwtowveto, "tauveto_Down"+tag, "wen_weights_%s_tauveto_%s_Down"%(cid,cid), _fOut)
  CRs[1].add_nuisance_shape("tauveto_%s"%cid,_fOut)
