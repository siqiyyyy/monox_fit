...
def cmodel(cid,nam,_f,_fOut, out_ws, diag, year):
  ...
  CRs[0].add_nuisance_shape("mettrig_%s"%year,_fOut, functype='lognorm')
  ...
  CRs[0].add_nuisance_shape("eveto_id_%s"%year,_fOut, functype='lognorm')
  ...
  CRs[0].add_nuisance_shape("eveto_reco_%s"%year,_fOut, functype='lognorm')
  ...
  CRs[0].add_nuisance_shape("muveto_id_%s"%year,_fOut, functype='lognorm')
  ...
  CRs[0].add_nuisance_shape("muveto_iso_%s"%year,_fOut, functype='lognorm')
  ...
  CRs[0].add_nuisance_shape("tauveto_%s"%year,_fOut, functype='lognorm')
  ...
  CRs[1].add_nuisance_shape("eveto_id_%s"%year,_fOut, functype='lognorm')
  ...
  CRs[1].add_nuisance_shape("eveto_reco_%s"%year,_fOut, functype='lognorm')
  ...
  CRs[1].add_nuisance_shape("muveto_id_%s"%year,_fOut, functype='lognorm')
  ...
  CRs[1].add_nuisance_shape("muveto_iso_%s"%year,_fOut, functype='lognorm')
  ...
  CRs[1].add_nuisance_shape("tauveto_%s"%year,_fOut, functype='lognorm')
  ...
  CRs[1].add_nuisance_shape("CMS_eff{YEAR}_e".format(**filler),_fOut, functype='lognorm')
  ...
  CRs[1].add_nuisance_shape("CMS_eff{YEAR}_e_reco".format(**filler),_fOut, functype='lognorm')
  ...
  if year == 2017:
    ...
    CRs[0].add_nuisance_shape("prefiring",_fOut, functype='lognorm')
  ...
  CRs[0].add_nuisance_shape("w_over_w_pdf",_fOut, functype='lognorm')
  CRs[1].add_nuisance_shape("w_over_w_pdf",_fOut, functype='lognorm')
