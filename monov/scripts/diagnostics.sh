...
for YEAR in 2017 2018; do
    for TAGGER in nominal MD; do
        for WP in tight loose; do
            combine -M FitDiagnostics --saveShapes --saveWithUncertainties --setParameters mask_monov${WP}_signal=1 -n _${TAGGER}_monov${WP}_${YEAR} ../cards/card_${TAGGER}_monov${WP}_${YEAR}.root
